    ...
    <div className='w-full h-[100vh] fixed top-0 z-[100] flex justify-center items-center'>
      ...
      <div className='w-[90%] max-w-[500px] h-[600px] bg-white relative overflow-auto z-[200] shadow-lg rounded-lg p-[10px]'>
        ...
        <div className='w-full flex flex-col items-center justify-center gap-[20px] mt-[50px]'>
              ...
              <div className='flex flex-col gap-[10px]'>
                {skills.map((skill, index) => (
                  <div key={index} className='w-full h-[40px] border-[1px] border-gray-600 bg-gray-200 rounded-lg p-[10px] flex justify-between items-center'>
                    <span>{skill}</span>
                    <RxCross1 className='w-[20px] h-[20px] cursor-pointer text-gray-800 font-bold' onClick={() => removeSkill(skill)} />
                  </div>
                ))}
              </div>
            )}
              ...
              <div className='flex flex-col gap-[10px]'>
                {education.map((edu, index) => (
                  <div key={index} className='w-full border-[1px] border-gray-600 bg-gray-200 rounded-lg p-[10px] flex justify-between items-center'>
                    ...
                    <RxCross1 className='w-[20px] h-[20px] cursor-pointer text-gray-800 font-bold' onClick={() => removeEducation(edu)} />
                  </div>
                ))}
              </div>
            )}
              ...
              <div className='flex flex-col gap-[10px]'>
                {experience.map((exp, index) => (
                  <div key={index} className='w-full border-[1px] border-gray-600 bg-gray-200 rounded-lg p-[10px] flex justify-between items-center'>
                    ...
                    <RxCross1 className='w-[20px] h-[20px] cursor-pointer text-gray-800 font-bold' onClick={() => removeExperience(exp)} />
                  </div>
                ))}
              </div>
            )}
          ...
          <button className='w-[100%] h-[50px] rounded-full bg-[#24b2ff] mt-[40px] text-white' disabled={saving} onClick={handleSaveProfile}>
